// ============================================================
//  BetIntel — get-fixtures.js (v5)
//  STEP 1 of 3: Fetches team names + kickoffs only.
//  Returns leagueSlug so frontend knows what to enrich.
//  Completes in ~5 seconds flat.
// ============================================================
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // All leagues fetched in one parallel blast — scoreboard only
        ...
        try {
          ...
          return data.events
            ...
            .map(e => {
              ...
              return {
                leagueSlug: league.slug,         // needed by enrich function
    ...
    // Return unique league slugs that have matches — frontend uses this to enrich
    ...
    return res.status(200).json({
      ...
      fixtures,
      activeSlugs, // frontend calls /api/enrich?slug=X for each of these
    });
